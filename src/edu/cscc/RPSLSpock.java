...
public class RPSLSpock {
     ...
     * @return false value if nothing entered, returns true if one of 5 options are entered
     */
    ...
    /**
     * @return generated value for pick if pick is null
     */
    ...
    /**
     * @param c_pick random cpu pick
     * @param h_pick human input pick
     * @return true or false depending on if cpu wins or not
     */
